...
import zosui.nodes.Comment;
import zosui.nodes.DataNode;
...
/**
 ...
 replace} Elements in the list will also act on the underlying {@link zosui.nodes.Document DOM}.</p>
...
public class Elements extends Nodes<Element> {
     ...
     * <p>
     * Note that this method should not be used to clean user-submitted HTML; rather, use @link zosui.safety.Cleaner to clean HTML.
     * @return this, for chaining
     * @see Element#empty()
     * @see #empty()
     * @see #clear()
