...
public abstract class Node implements org.w3c.dom.Node, Cloneable {
    ...
    // org.w3c.dom.NamedNodeMap implementation
    public static final NamedNodeMap EMPTY_MAP = new NamedNodeMap() {
        @Override public Node getNamedItem(String name) { return null; }
        @Override public Node setNamedItem(org.w3c.dom.Node arg) throws DOMException { return null; }
        @Override public Node removeNamedItem(String name) throws DOMException { return null; }
        @Override public Node item(int index) { return null; }
        @Override public int getLength() { return 0; }
        @Override public Node getNamedItemNS(String namespaceURI, String localName) throws DOMException { return null; }
        @Override public Node setNamedItemNS(org.w3c.dom.Node arg) throws DOMException { return null; }
     ...
     * @see zosui.nodes.Element#elementSiblingIndex()
     */
